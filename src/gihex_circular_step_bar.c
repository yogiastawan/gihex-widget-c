...
void gihex_circular_step_bar_set_property(GObject *object, guint property_id, const GValue *value, GParamSpec *pspec)
{
    ...
    case PROP_COLOR_TRACK:
    {
        ...
        gihex_circular_step_bar_set_color_track(self, gihex_color_new(clr->red * 255, clr->green * 255, clr->blue * 255, clr->alpha * 255));
        break;
    }
    case PROP_COLOR_STROKE:
    {
        GdkRGBA *clr1 = g_value_get_boxed(value);
        gihex_circular_step_bar_set_color_stroke(self, gihex_color_new(clr1->red * 255, clr1->green * 255, clr1->blue * 255, clr1->alpha * 255));
        break;
    }
    case PROP_COLOR_BAR:
    {
        GdkRGBA *clr2 = g_value_get_boxed(value);
        gihex_circular_step_bar_set_color_bar(self, gihex_color_new(clr2->red * 255, clr2->green * 255, clr2->blue * 255, clr2->alpha * 255));
        break;
    }
